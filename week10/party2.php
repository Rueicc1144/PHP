                            ...
                            <div class="mx-3">
                                <form name="register" method="POST" action="party_check.php" enctype="MIME">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="one" name="sgrade" value="大一">
                                        <label class="ratio-label" for="one">
                                            大一 
                                        </label>
                                        <input type="radio" id="two" name="sgrade" value="大二">
                                        <label class="ratio-label" for="two">
                                            大二 
                                        </label>
                                        <input type="radio" id="three" name="sgrade" value="大三">
                                        <label class="ratio-label" for="three">
                                            大三 
                                        </label>
                                        <input type="radio" id="four" name="sgrade" value="大四">
                                        <label class="ratio-label" for="four">
                                            大四 
                                        </label>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="age" min="1" max="99" value="18" >
                                    </div>

                                    <!--email-->
                                    <div class="mb-3">
                                        <label for="email" class="label">電子信箱</label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="123SPants@gmail.com">
                                    </div>
